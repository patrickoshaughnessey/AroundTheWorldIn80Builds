...
//@input Asset.AudioTrackAsset[] deleteFaceAsset
const deleteFacePool = new InstSoundPooled(script.deleteFaceAsset, poolSizeDeleteFace, waitTime);
script.deleteFace = deleteFacePool.instance;